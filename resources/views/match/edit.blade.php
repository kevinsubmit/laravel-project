...
<article class="page-container">
    <form method="post" action="/match_edit" enctype="multipart/form-data" class="form form-horizontal" id="form-match-edit">
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">赛事名称：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="{{ $match_info->m_title }}" placeholder="" id="articletitle" name="m_title">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">开盘时间：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="{{ $match_info->m_status_time }}" placeholder="" id="articletitle" name="m_status_time">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">上盘球队：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="{{ $match_info->m_home_team }}" placeholder="" id="articletitle" name="m_home_team">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">盘口：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="{{ $match_info->m_change }}" placeholder="" id="articletitle" name="m_change">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">下盘球队：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="{{ $match_info->m_visiting_team }}" placeholder="" id="articletitle" name="m_visiting_team">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">免费推荐：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="{{ $match_info->m_recommend }}" placeholder="" id="articletitle" name="m_recommend">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">比分：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="{{ $match_info->m_score }}" placeholder="" id="articletitle" name="m_score">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">结果：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="{{ $match_info->m_result }}" placeholder="" id="articletitle" name="m_result">
            </div>
        </div>
        <input type="hidden" value="{{ $match_info->m_id }}" name="m_id">
        <input type="hidden" value="{{ $match_info->m_is_top }}" name="m_is_top">
        <div class="row cl">

...
<article class="page-container">
    <form method="post" action="/newsinformation_add" enctype="multipart/form-data" class="form form-horizontal" id="form-article-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                链接 <input type="radio" class="link_content" name="n_type" value="1">
                内容 <input type="radio" class="link_content" name="n_type" value="0">
            </div>
        </div>
        <div class="row cl new_link" style="display:none;">
            <label class="form-label col-xs-4 col-sm-2">链接：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="" id="" name="n_link">
            </div>
        </div>

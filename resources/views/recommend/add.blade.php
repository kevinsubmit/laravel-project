...
<article class="page-container">
    <form method="post" action="/recommend_add" enctype="multipart/form-data" class="form form-horizontal" id="form-add">
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>活动标题：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="" id="r_title" name="r_title">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>活动图片（600*360）：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="file" name="r_img" id="r_img">
            </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                是：<input type="radio" value="1" name="is_show" class="is_show">&nbsp;&nbsp;
                否：<input type="radio" value="0" name="is_show" class="is_show">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>活动链接/活动内容：</label>
            <div class="formControls col-xs-8 col-sm-9"><span class="isshow_url">添加链接：<input type="checkbox" id="cli_url"></span>&nbsp;&nbsp;&nbsp;&nbsp;<span class="isshow_content">添加内容：<input type="checkbox" id="cli_content"></span><span class="show_url" style="display:none"><input type="text" id="r_url_input" class="input-text" value="" placeholder="" name="r_url"></span><span class="show_content" style="display: none"><script id="editor" type="text/plain" style="width:100%;height:400px;"></script></span><span id="alert_info" style="color:red"></span></div>
        </div>

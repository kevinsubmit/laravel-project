...
<article class="page-container">
    <form action="/navigation_spare_edit_info" method="post" class="form form-horizontal" id="form-admin-edit">
        <div class="row cl">
        ...
        <input type="hidden" id="type" value="{{  $navigation->n_type }}">
        <div class="row cl">
    ...
    $(function(){
        $("#form-admin-edit").validate({
            ...
            submitHandler:function(form){
                ...
                window.location.href = '/navigation_headTitle_edit_info?n_id=' + n_id + '&n_url=' + n_url + '&n_type=' + n_type + '&n_remark=' + n_remark;
            }
        });
    });
</script>

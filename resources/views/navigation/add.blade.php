    ...
    <form method="post" action="/navigation_add" enctype="multipart/form-data" class="form form-horizontal" id="form-add">
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <select name="n_type" id="n_type" class="select">
                    {{--<option value="1">投注区</option>--}}
                    {{--<option value="2">广告站</option>--}}
                    <option value="1">前台</option>
                    <option value="3">代理</option>
                    <option value="5">全讯网</option>
                    <option value="6">导航网</option>
                    <option value="4">服务项目导航</option>
                </select>
            </div>
        </div>
        <div class="row cl">

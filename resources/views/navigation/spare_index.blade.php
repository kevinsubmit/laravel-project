...
<script type="text/javascript">
    $(function(){
        ...
        $('.edit').bind("click",function(){
            var url = '/navigation_spare_edit'+'?id='+$(this).attr('data-id');
            var title = '修改导航域名';
            layer_show(title, url, '800', '300');
        });
        ...
        $('#btn-search').click(function(){
            ...
            window.location.href = '/navigation_spare_search?navigation_type=' + navigation_type + '&navigation_name=' + navigation_name;
        });
    })
</script>
</body>

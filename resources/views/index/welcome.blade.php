...
<div class="page-container">
    <p class="f-20 text-success">欢迎登陆全讯网管理端！</p>
    <p>登录次数：{{ $user_info->login_num }} </p>
    <p>上次登录IP：{{ $user_info->ip }}  上次登录时间：{{ $user_info->updated_at }}</p>
...
<script type="text/javascript" src="{{ URL::asset('/Huiadmin/static/h-ui/js/H-ui.min.js') }}"></script>
</body>
</html>